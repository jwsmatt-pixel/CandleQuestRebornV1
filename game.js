const CANDLE_QUEST_BUILD = "v14_verified_7s_quest_timer";
...
function startRun(worldId=activeWorld){
  ...
  run = {
    ...
    // v14 verified quest timer.
    // Timer is inactive while market replays.
    // Timer runs for 7 seconds only during Quest Moment.
    questCount:0,
    maxQuests:10,
    questTime:7,
    questLeft:7,
  ...
  openScreen("game");
  drawGame();
  // v14: No global 90-second countdown.
  // The visible timer starts only during Quest Moment.
  run.timer = null;
