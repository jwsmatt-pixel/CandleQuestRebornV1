...
## v14 verified 7-second Quest Moment timer

- Adds a visible build badge: `v14 · Quest Timer`.
- Removes the global 90-second run countdown.
- Time box shows `—` while the market/setup is replaying.
- Timer starts only at Quest Moment.
- Each Quest Moment gives 7 seconds to answer.
